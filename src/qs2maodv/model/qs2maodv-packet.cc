 ...
 *
 * Based on
 *      NS-2 QMAODV model developed by the CMU/MONARCH group and optimized and
 *      tuned by Samir Das and Mahesh Marina, University of Cincinnati;
 *
 *      QMAODV-UU implementation by Erik Nordström of Uppsala University
 *      https://web.archive.org/web/20100527072022/http://core.it.uu.se/core/index.php/QMAODV-UU
 *
...
{
    static TypeId tid = TypeId("ns3::qs2maodv::TypeHeader")
                            .SetParent<Header>()
...
TypeHeader::Deserialize(Buffer::Iterator start)
{
    ...
    switch (type)
    {
    case QS2MAODVTYPE_RREQ:
    case QS2MAODVTYPE_RREP:
    case QS2MAODVTYPE_RERR:
    case QS2MAODVTYPE_RREP_ACK: {
...
{
    static TypeId tid = TypeId("ns3::qs2maodv::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("Qs2maodv")
...
{
    static TypeId tid = TypeId("ns3::qs2maodv::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("Qs2maodv")
...
{
    static TypeId tid = TypeId("ns3::qs2maodv::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("Qs2maodv")
...
{
    static TypeId tid = TypeId("ns3::qs2maodv::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("Qs2maodv")
