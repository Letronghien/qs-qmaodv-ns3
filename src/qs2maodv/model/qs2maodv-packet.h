 ...
 */
#ifndef QMAODVPACKET_H
#define QMAODVPACKET_H
...
enum MessageType
{
    QS2MAODVTYPE_RREQ = 1,    //!< QS2MAODVTYPE_RREQ
    QS2MAODVTYPE_RREP = 2,    //!< QS2MAODVTYPE_RREP
    QS2MAODVTYPE_RERR = 3,    //!< QS2MAODVTYPE_RERR
    QS2MAODVTYPE_RREP_ACK = 4 //!< QS2MAODVTYPE_RREP_ACK
};
...
class TypeHeader : public Header
{
  public:
    /**
     * constructor
     * \param t the QMAODV RREQ type
     */
    TypeHeader(MessageType t = QS2MAODVTYPE_RREQ);
