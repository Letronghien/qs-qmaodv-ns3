 ...
 */
#ifndef QMAODV_RQUEUE_H
#define QMAODV_RQUEUE_H
...
/**
 * \ingroup qmaodv
 * \brief QMAODV route request queue
 *
 * Since QMAODV is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
